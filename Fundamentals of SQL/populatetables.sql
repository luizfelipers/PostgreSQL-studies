-- this script is intended to populate tables from the Movie Database
...
-- populating the Movies table with data
...
-- populating de movie's revenues table
...
-- POPULATING THE MOVIES x ACTOR table. The combination of actor_id and Movie_id represents it's primary key
